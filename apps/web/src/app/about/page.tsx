          ...
          <section>
            ...
            <div className="prose prose-sm md:prose-base dark:prose-invert max-w-none text-foreground font-medium leading-relaxed">
              <p className="text-lg font-bold leading-relaxed mb-4 text-card-foreground">
                ...
                beautiful, functional, and user-centric interfaces.
              </p>
              <p className="text-muted-foreground">
                I specialize in building fast, accessible web applications using
                modern technologies. I focus on delivering great user
                experiences through careful attention to detail in both code
                architecture and visual design. Everything from robust system
                design to the smallest micro-interaction matters.
              </p>
            </div>
          </section>
