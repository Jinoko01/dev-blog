...
const DEFAULT_VALUES: AlgorithmFormValues = {
  title: "",
  platform: "백준",
  difficulty: "",
  language: "typescript",
...
export function AlgorithmForm({
  ...
  initialValues?: AlgorithmFormValues;
  submitLabel: string;
  pendingLabel: string;
  publishLabel?: string;
  onSubmit: (values: AlgorithmFormValues) => Promise<void>;
}) {
  const [loading, setLoading] = useState(false);
  const [formData, setFormData] = useState<AlgorithmFormValues>(initialValues);
